...
<p>The plugin classes are not required plugins, but are added to the system (as opposed to the application) so that they can be used across all applications within your environment. This step will allow you to install them.</p>
...
$configPaths = File_Scan::scanRecursive(SYS_PATH . "/plugin-classes", "*.config.php");
...
if($madeSelection)
{
	foreach($configPaths as $configPath)
	{
		...
		if(!$classConfig = Classes_Meta::getConfig($class, SYS_PATH . "/plugin-classes"))
		{
