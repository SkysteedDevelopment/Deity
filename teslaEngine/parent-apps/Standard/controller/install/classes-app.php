...
foreach($configPaths as $configPath)
{
	...
	// If the config was returned as an array:
	// TODO: Eventually, all configs should use this format:
	if(is_array($classConfig))
	{
		echo '<h4>' . $class . ' - v' . $classConfig['Version'] . '</h4>
		<p>
	...
	{
		// If the config was returned as a class
...
echo '
<a class="button" href="/install/app-custom">Continue with Installation</a>';
