...
if(count($url) > 0 && $url[0] != "")
{
	...
	while(true)
	{
		...
		if(File::exists(ROUTE_PATH . "/" . $checkPath . ".php"))
		{
			require(ROUTE_PATH . "/" . $checkPath . ".php"); exit;
		}
	...
	{
		// Check if the appropriate path exists. Load it if it does.
		if(File::exists(ROUTE_SECOND_PATH . "/" . $checkPath . ".php"))
		{
			require(ROUTE_SECOND_PATH . "/" . $checkPath . ".php"); exit;
		}
