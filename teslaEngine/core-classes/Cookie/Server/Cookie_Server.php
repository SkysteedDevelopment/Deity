...
/****** Create Cookies w/ Authentication ******/
	...
	// Cookie_Server::set($cookieName, $cookieValue, [$cookieSalt], [$expiresInDays]);
	{
		...
		// Set the cookie
		setcookie($cookieName, $valueToRemember, $timestamp + (86400 * $expiresInDays), "/", URL_PREFIX . $domain);
		setcookie($cookieName . "_key", $token, $timestamp + (86400 * $expiresInDays), "/", URL_PREFIX . $domain);
	}
